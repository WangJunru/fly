...
import com.fly.util.ABTextUtil;
...
//        Logger.d(TAG, "scrollview: " + scrollView);
        Debug.log.d(TAG, "parent: " + this.getParent());
...
//                    Logger.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        if (0 == itemHeight) {
            itemHeight = Tools.getViewMeasuredHeight(tv);
            Debug.log.d(TAG, "itemHeight: " + itemHeight);
...
//            position = divided + offset + 1;
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (viewWidth == 0) {
            ...
            Debug.log.d(TAG, "viewWidth: " + viewWidth);
        }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Debug.log.d(TAG, "w: " + w + ", h: " + h + ", oldw: " + oldw + ", oldh: " + oldh);
        viewWidth = w;
