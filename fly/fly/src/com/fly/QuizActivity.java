...
public class QuizActivity extends BaseActivity  implements OnCheckedChangeListener,OnItemClickListener{
	...
	private Dialog loadQstMaskDialog ;
	...
	private UserScoreCreate userScoreCommit ;
     ...
     private void   showTaskDoingDialog(int strId)
 	{
 		...
 		{
 			loadQstMaskDialog  = new Dialog(this);
 			loadQstMaskDialog.setCancelable(false);
 			loadQstMaskDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
 			loadQstMaskDialog.getWindow().addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
 			loadQstMaskDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
 			loadQstMaskDialog.setContentView(R.layout.login_tip_dialog_layout);	
		...
		TextView  loadingTip = (TextView)loadQstMaskDialog.findViewById(R.id.login_tip);
		loadingTip.setText(strId);	
 	}
    ...
    {
          AlertDialog alertDlg = new AlertDialog.Builder(this).setMessage(R.string.jiao_queren)
          	  .setPositiveButton(R.string.yes, new OnClickListener() {
  				
  				@Override
  				public void onClick(DialogInterface dialog, int which) {
  					// TODO Auto-generated method stub 处理交卷逻辑
  					dealWithJiaoJuanJob();
    ...
    {
    	    AlertDialog alertDlg = new AlertDialog.Builder(this).setMessage(R.string.quiz_timeout)
              	  .setPositiveButton(R.string.yes, new OnClickListener() {
