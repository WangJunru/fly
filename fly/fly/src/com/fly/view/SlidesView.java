...
import com.fly.R;
import com.fly.ViewPagerAdapter;
...
public class SlidesView extends FrameLayout {
	...
	{
		 LayoutInflater.from(getContext()).inflate(R.layout.slides_view_layout, this);
		 pannerViewPager = (ViewPager) this.findViewById(R.id.slides_view_pager);
		 viewGuideDotsCon = (LinearLayout)this.findViewById(R.id.slides_guide_dots);
	...
	private void addGuidesDots()
	{
		...
		dot.setImageResource(R.drawable.guide_dot_selector);
...
//		         child.y = height;
	...
	private void setCurrentDot(int position) {
		...
		guideDots.get(position).setSelected(false);
